...
let schemes: [Scheme] = [
    ...
    .scheme(
        ...
        testAction: .targets(
            [
                .testableTarget(target: "Listen-anonymously-Tests", isParallelizable: true),
                .testableTarget(target: "Listen-Anonymously-Shared-Tests", isParallelizable: true),
                .testableTarget(target: "Listen-anonymously-Ext-Tests", isParallelizable: true),
                .testableTarget(target: "Listen-anonymously-Snapshot-Tests"),
                .testableTarget(target: "Listen-anonymously-UITests"),
            ],
            configuration: "Debug",
            options: .options(
                coverage: true,
